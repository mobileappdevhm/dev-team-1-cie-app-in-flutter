...
class StaticVariables {
  ...
  static const String PRIVACY_TEXT_GERMAN = "Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der Verarbeitung von personenbezogenen Daten (nachfolgend kurz “Daten”) innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie externen Onlinepräsenzen, wie z.B. unser Social Media Profile auf (nachfolgend gemeinsam bezeichnet als “Onlineangebot”). Im Hinblick auf die verwendeten Begrifflichkeiten, wie z.B. “Verarbeitung” oder “Verantwortlicher” verweisen wir auf die Definitionen im Art. 4 der Datenschutzgrundverordnung (DSGVO)\n\n" +
      ...
      "\nWir setzen auf Grundlage unserer berechtigten Interessen (d.h. Interesse an der Analyse, Optimierung unser App im Sinne des Art. 6 Abs. 1 lit. f. DSGVO) Google Firebase Analytics, einen Analysedienst der Google LLC (“Google”) ein. Die erzeugten Informationen über Benutzung der App durch die Nutzer werden Anonymisiert und in der Regel an einen Server von Google in den USA übertragen und dort gespeichert." +
      "\nGoogle ist unter dem Privacy-Shield-Abkommen zertifiziert und bietet hierdurch eine Garantie, das europäische Datenschutzrecht einzuhalten (https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&amp;status=Active)." +
      "\nGoogle wird diese Informationen in unserem Auftrag benutzen, um die Nutzung unserer App durch die Nutzer auszuwerten, um Reports über die Aktivitäten innerhalb dieses Appangebotes zusammenzustellen und um weitere, mit der Nutzung dieses Appangebotes und der Internetnutzung verbundene Dienstleistungen, uns gegenüber zu erbringen. Dabei können aus den verarbeiteten Daten pseudonyme Nutzungsprofile der Nutzer erstellt werden." +
      "\nWir setzen Google Firebase Analytics nur mit aktivierter IP-Anonymisierung ein. Das bedeutet, die IP-Adresse der Nutzer wird von Google innerhalb von Mitgliedstaaten der Europäischen Union oder in anderen Vertragsstaaten des Abkommens über den Europäischen Wirtschaftsraum gekürzt. Nur in Ausnahmefällen wird die volle IP-Adresse an einen Server von Google in den USA übertragen und dort gekürzt." +
      "\nDie von der App des Nutzers übermittelte IP-Adresse wird nicht mit anderen Daten von Google zusammengeführt. Die Nutzer können die erhebung der Daten in unseren Einstellungen verhindern." +
  ...
  static const String PRIVACY_TEXT_ENGLISH = "This data protection declaration explains to you the type, scope and purpose of the processing of personal data (hereinafter referred to as “data”) within our online offer and the associated websites, functions and contents as well as external online presences, e.g. our social media profile (hereinafter jointly referred to as “online offer”). With regard to the terms used, such as “processing” or “person responsible”, we refer to the definitions in Art. 4 of the General Data Protection Regulation (GDPR)\n\n" +
      ...
      "\n\nGoogle Firebase Analytics\n" +
      "On the basis of our legitimate interests (i.e. interest in the analysis, optimisation of our app within the meaning of Art. 6 para. 1 lit. f. DSGVO) Google Firebase Analytics, an analysis service of Google LLC (\"Google\")." +
      "\nThe information generated about users' use of the app is anonymized and usually transmitted to a Google server in the USA and stored there. Google is certified under the Privacy Shield Agreement and thus offers a guarantee to comply with European data protection law (https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&amp;status=Active)." +
      "\nGoogle will use this information on our behalf to evaluate the use of our app by users, to compile reports on the activities within this app offer and to provide us with further services associated with the use of this app offer and Internet use." +
      "\nWe use Google Firebase Analytics only with activated IP anonymization. This means that Google will reduce the IP address of users within Member States of the European Union or in other states party to the Agreement on the European Economic Area." +
      "\nOnly in exceptional cases will the full IP address be transmitted to a Google server in the USA and shortened there. The IP address transmitted by the user's app will not be merged with other Google data." +
      "\nUsers can prevent the collection of data in our settings. Users' personal data will be deleted or made anonymous after 14 months. Integration of third-party services and content. Within our online offer, we make no representations or warranties of any kind based on our legitimate interests (i.e. interest in the analysis, optimisation and economic operation of our online" +
      "offer within the meaning of Art. 6 para. 1 lit. f.  DSGVO) content or service offerings of third parties to incorporate their content and services, such as videos or fonts (hereinafter uniformly referred to as \"content\"). This always presupposes that the third party providers of this content perceive the IP address of the users, since without the IP address they could not send the content to their browser." +
      "The IP address is therefore required for the display of this content. We make every effort to use only those contents whose respective providers use the IP address only for the delivery of the contents. Third-party providers may also use so-called pixel tags (invisible graphics, also known as \"web beacons\") for statistical or marketing purposes. The \"pixel tags\" allow information such as visitor traffic on the pages of this website to be evaluated. The pseudonymous information may also be stored in cookies on the user's device and may include technical information about the browser and operating system, referring websites, visiting time and other information about the use of our online offer, as well as be linked to such information from other sources." +
      ...
      "\n\nNine\n" +
      "We use the Nine Service of the Munich University of Applied Sciences. All concrete user data are at nine.wi.hm.edu.";
}
