...
class CampusUtility {
  static String getCampusAsString(Campus campus, BuildContext context) {
    switch (campus) {
      case Campus.KARLSTRASSE:
        return S.of(context).course_campusShort_karlstrasse;
      case Campus.LOTHSTRASSE:
        return S.of(context).course_campusShort_lothstrasse;
      case Campus.PASING:
        return S.of(context).course_campusShort_pasing;
    }
    return "";
  }
}
