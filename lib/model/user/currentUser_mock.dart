...
class CurrentUserMock implements CurrentUser {
  ...
  CurrentUserMock() {
    prevCourses.add(new Course("Title of Course 1", "07", "Mo", "10:00", "11:30", "Some description 1",
        1, 1, "test@test.de", "Test",
        1, false, 1));
    prevCourses.add(new Course("Title of Course 2", "07", "Mo", "12:00", "13:30", "Some description 2",
        1, 1, "test@test.de", "Test",
        1, true, 0));
    prevCourses.add(new Course("Title of Course 3", "07", "Di", "9:45", "11:30", "Some description 3",
        1, 1, "test@test.de", "Test",
        1, false, 2));
    prevCourses.add(new Course("Title of Course 4", "07", "Mo", "10:00" ,"11:30", "Some description 4",
        1, 1, "test@test.de", "Test",
        1, true, 0));
