...
void main(){
  group("simpleRenderTest", () {
    test('rendersAvailableIcon', () {
      final Icon availableIcon = GenericIcon.buildGenericAvailabilityIcon(CourseAvailability.AVAILABLE);
    ...
    test('rendersPendingIcon', () {
      final Icon pendingIcon = GenericIcon.buildGenericAvailabilityIcon(CourseAvailability.PENDING);
    ...
    test('rendersUnavailableIcon', () {
      final Icon unavailableIcon = GenericIcon.buildGenericAvailabilityIcon(CourseAvailability.UNAVAILABLE);
    ...
    test('rendersActiveFavoriteIcon', () {
      final Icon activeFavoriteIcon = GenericIcon.buildGenericFavoriteIcon(true);
      expect(activeFavoriteIcon.color, CiEColor.red);
      expect(activeFavoriteIcon.icon.codePoint, GenericIcon.memStorageActiveFavorite);
      expect(activeFavoriteIcon.icon.fontFamily, GenericIcon.fontFamily);
    });

    test('rendersInactiveFavoriteIcon', () {
      final Icon inactiveFavoriteIcon = GenericIcon.buildGenericFavoriteIcon(false);
      expect(inactiveFavoriteIcon.color, CiEColor.red);
      expect(inactiveFavoriteIcon.icon.codePoint, GenericIcon.memStorageInactiveFavorite);
