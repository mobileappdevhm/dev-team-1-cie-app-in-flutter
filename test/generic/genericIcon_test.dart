...
void main(){
  group("simpleRenderTest", () {
    test('rendersAvailableIcon', () {
      final Icon availableIcon = GenericIcon.buildGenericAvailabilityIcon(0);
    ...
    test('rendersPendingIcon', () {
      final Icon pendingIcon = GenericIcon.buildGenericAvailabilityIcon(1);
    ...
    test('rendersUnavailableIcon', () {
      final Icon unavailableIcon = GenericIcon.buildGenericAvailabilityIcon(2);
